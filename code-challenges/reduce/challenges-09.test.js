...
const countNumberOfElements = (arr) => {
  let elements = arr.reduce( function(accumulator, value, index){
    accumulator ++;
    return accumulator;
  }, 0);
  return elements;
...
const returnNames = (arr) => {
  let starNames = arr.reduce( function(accumulator, character){
...
const reversedString = (str) => {
  str = str.split('');
  let reverseString = str.reduce((acc , value, idx) => { 
      acc = acc + str[str.length - idx - 1]
      return acc
  },'');
...
const countNumberOfChildren = (arr) => {
  let howMany = arr.reduce((accumulator, value, idx)=> {
...
const calculateAverage = (arr) => {
  let average = arr.reduce((accumulator, value, index) =>{
   accumulator.counter = accumulator.counter + 1;
   accumulator.total = accumulator.total + value
   return accumulator
  }, {counter: 0, total: 0});
  return average.total/average.counter;
};
...
const countPrimeNumbers = (arr) => {
  let totalPrime = arr.reduce((accumulator, value, index) =>{
